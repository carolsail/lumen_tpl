...
const Upload = {
    ...
    events: {
            ...
            if (maxcount > 0 && input_id) {
                ...
                if (inputObj.size() > 0) {
                    ...
                    if (files.length > remains) {
                        ...
                        layer.msg('You can upload up to '+remains+'file');
                        return false;
                    }
                }
            }
        ...
        onUploadError: function (up, ret) {
            ...
            layer.msg(ret.msg + "(code:" + ret.code + ")", {icon: 5});
        },
        //服务器响应数据后
                ...
                if (preview_id && input_id) {
                    $(document.body).on("keyup change", "#" + input_id, function () {
                        ...
                        $.each(inputArr, function (i, j) {
                            ...
                            var data = {url: j, fullurl: fixurl(j), data: $(that).data()};
                            //console.log(data)
